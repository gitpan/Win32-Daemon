...
//  
//  This file adapts to the version of Perl being used: 5.003, 5.004, 5.005 with or
//  without support for PERL_OBJECT.
//  
//  1999.11.14 roth   
//
...
#       define  PERL_OBJECT_PROTO1  CPerl *pPerl
#		define  PERL_OBJECT_ARGS    pPerl,
#       define  PERL_OBJECT_ARG     pPerl
#   else // PERL_OBJECT
#       define  PERL_BRAND          "Core Distribution"
#       undef   PERL_OBJECT_CLASS
